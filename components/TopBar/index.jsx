	...
	return (
		<div className="w-screen h-28 max-xl:h-12 pl-[var(--page-padding-left)] pr-[var(--page-padding-right)] py-6 max-xl:py-2 flex gap-16 max-xl:gap-8 items-center justify-between fixed top-0 left-0 right-0 z-50 bg-background border-b border-b-secondary">
			...
			<div className="h-full w-full flex gap-4 justify-end items-center">
				<Link href={"/featured-projects"} className="px-4 xl:w-fit xl:h-full max-xl:w-8 max-xl:h-8 p-1 rounded-lg border border-secondary bg-primary flex justify-center items-center hover:border-accent cursor-pointer transition-all duration-200">
				...
				<Link href={"/committee"} className="px-4 xl:w-fit xl:h-full max-xl:w-8 max-xl:h-8 max-xl:aspect-square p-1 rounded-lg border border-secondary bg-primary flex justify-center items-center hover:border-accent cursor-pointer transition-all duration-200">
					<div className="flex gap-1 justify-center items-center">
				...
				<Link href={"/events"} className="px-4 xl:w-fit xl:h-full max-xl:w-8 max-xl:h-8 max-xl:aspect-square p-1 rounded-lg border border-secondary bg-primary flex justify-center items-center hover:border-accent cursor-pointer transition-all duration-200">
					<div className="flex gap-1 justify-center items-center">
				...
				<Link href={"https://my.exeterguild.com/groups/QRM97/computer-science-society/memberships"} target={"_blank"} className="px-4 xl:w-fit xl:h-full max-xl:w-8 max-xl:h-8 max-xl:aspect-square p-1 rounded-lg border border-secondary bg-primary flex justify-center items-center hover:border-accent cursor-pointer transition-all duration-200">
					<div className="flex gap-1 justify-center items-center">
