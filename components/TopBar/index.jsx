...
export function TopBar() {
	return (
		<div className="w-screen h-28 max-xl:h-12 pl-[var(--page-padding-left)] pr-[var(--page-padding-right)] pt-6 flex gap-16 items-center justify-between fixed top-0 left-0 right-0 z-50 bg-background pb-6 border-b border-b-secondary">
			<Link href={"/"}>
			...
			<div className="h-full w-full flex gap-4 justify-center items-center">
				<Link href={"/featured-projects"} className="xl:w-fit xl:h-full max-xl:w-8 max-xl:h-8 max-xl:aspect-square p-1 rounded-lg border border-secondary bg-primary flex justify-center items-center hover:border-accent cursor-pointer transition-all duration-200">
