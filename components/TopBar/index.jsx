...
export function TopBar() {
	return (
		<div className="w-full h-28 pl-[var(--page-padding-left)] pr-[var(--page-padding-right)] pt-6 flex gap-16 items-center justify-around fixed top-0 left-0 right-0 z-50 bg-background pb-6 border-b border-b-secondary">
			<Link href={"/"}>
